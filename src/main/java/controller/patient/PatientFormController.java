...
public class PatientFormController implements Initializable {
    ...
    void btnDeleteOnAction(ActionEvent event) {
        Patient patient = new PatientController().searchPatientByNIC(txtSearch.getText());
        if (patient !=null){
            boolean isDeleted = new PatientController().deletePatient(txtSearch.getText());
            if(isDeleted){
                txtId.setText(new PatientController().nextId());
            }
        }
    ...
    public void loadTable(){
        ...
        List<Patient> patientArrayList = new PatientController().getAll();
